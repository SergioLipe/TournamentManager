...
INSERT INTO competidor (nome, imagem, TemaId) VALUES
    ('American Bison', 'Imagens/Animals/American-Bison.jpg', @t),
    ('Arctic Fox', 'Imagens/Animals/Arctic-Fox.jpg', @t),
    ('Atlantic Puffin', 'Imagens/Animals/Atlantic-Puffin.jpg', @t),
    ('Axolotl', 'Imagens/Animals/Axolotl.jpg', @t),
    ('Bald Eagle', 'Imagens/Animals/Bald-Eagle.jpg', @t),
    ...
    ('Chameleon', 'Imagens/Animals/Chameleon.jpg', @t),
    ...
    ('Flamingo', 'Imagens/Animals/Flamingo.jpg', @t),
    ...
    ('Green Sea Turtle', 'Imagens/Animals/Green-Sea-Turtle.jpg', @t),
    ('Hedgehog', 'Imagens/Animals/Hedgehog.jpg', @t),
    ('Hippopotamus', 'Imagens/Animals/Hippopotamus.jpg', @t),
    ('Honey Bee', 'Imagens/Animals/Honey-Bee.jpg', @t),
    ('Jaguar', 'Imagens/Animals/Jaguar.jpg', @t),
    ('King Cobra', 'Imagens/Animals/King-Cobra.jpg', @t),
    ('Koala', 'Imagens/Animals/Koala.jpg', @t),
    ('Komodo Dragon', 'Imagens/Animals/Komodo-Dragon.jpg', @t),
    ('Leopard', 'Imagens/Animals/Leopard.jpg', @t),
    ('Lion', 'Imagens/Animals/Lion.jpg', @t),
    ('Manta Ray', 'Imagens/Animals/Manta-Ray.jpg', @t),
    ('Meerkat', 'Imagens/Animals/Meerkat.jpg', @t),
    ('Monarch Butterfly', 'Imagens/Animals/Monarch-Butterfly.jpg', @t),
    ('Moose', 'Imagens/Animals/Moose.jpg', @t),
    ('Narwhal', 'Imagens/Animals/Narwhal.jpg', @t),
    ('Nile Crocodile', 'Imagens/Animals/Nile-Crocodile.jpg', @t),
    ('Octopus', 'Imagens/Animals/Octopus.jpg', @t),
    ('Orangutan', 'Imagens/Animals/Orangutan.jpg', @t),
    ('Orca', 'Imagens/Animals/Orca.jpg', @t),
    ('Ostrich', 'Imagens/Animals/Ostrich.jpg', @t),
    ('Peacock', 'Imagens/Animals/Peacock.jpg', @t),
    ('Platypus', 'Imagens/Animals/Platypus.jpg', @t),
    ('Polar Bear', 'Imagens/Animals/Polar-Bear.jpg', @t),
    ('Raccoon', 'Imagens/Animals/Raccoon.jpg', @t),
    ('Red Fox', 'Imagens/Animals/Red-Fox.jpg', @t),
    ('Red Kangaroo', 'Imagens/Animals/Red-Kangaroo.jpg', @t),
    ('Sea Otter', 'Imagens/Animals/Sea-Otter.jpg', @t),
    ('Seahorse', 'Imagens/Animals/Seahorse.jpg', @t),
    ('Sloth', 'Imagens/Animals/Sloth.jpg', @t),
    ('Snow Leopard', 'Imagens/Animals/Snow-Leopard.jpg', @t),
    ('Tiger', 'Imagens/Animals/Tiger.jpg', @t),
    ('Toucan', 'Imagens/Animals/Toucan.jpg', @t),
...
INSERT INTO tema (nome, utilizadorId, publico) VALUES ('Cat Breeds', @dono, 1)
    ON DUPLICATE KEY UPDATE publico = 1;
SET @t = (SELECT id FROM tema WHERE nome = 'Cat Breeds' AND utilizadorId = @dono);
DELETE FROM competidor WHERE TemaId = @t;
INSERT INTO competidor (nome, imagem, TemaId) VALUES
    ('Abyssinian', 'Imagens/Cat-Breeds/Abyssinian.jpg', @t),
    ('American Shorthair', 'Imagens/Cat-Breeds/American-Shorthair.jpg', @t),
    ('Balinese', 'Imagens/Cat-Breeds/Balinese.png', @t),
    ('Bengal', 'Imagens/Cat-Breeds/Bengal.jpg', @t),
    ('Birman', 'Imagens/Cat-Breeds/Birman.jpg', @t),
    ('Bombay', 'Imagens/Cat-Breeds/Bombay.jpg', @t),
    ('British Shorthair', 'Imagens/Cat-Breeds/British-Shorthair.jpg', @t),
    ('Burmese', 'Imagens/Cat-Breeds/Burmese.jpg', @t),
    ('Chartreux', 'Imagens/Cat-Breeds/Chartreux.jpg', @t),
    ('Cornish Rex', 'Imagens/Cat-Breeds/Cornish-Rex.jpg', @t),
    ('Devon Rex', 'Imagens/Cat-Breeds/Devon-Rex.jpg', @t),
    ('Egyptian Mau', 'Imagens/Cat-Breeds/Egyptian-Mau.jpg', @t),
    ('Exotic Shorthair', 'Imagens/Cat-Breeds/Exotic-Shorthair.jpg', @t),
    ('Himalayan', 'Imagens/Cat-Breeds/Himalayan.jpg', @t),
    ('Japanese Bobtail', 'Imagens/Cat-Breeds/Japanese-Bobtail.jpg', @t),
    ('Korat', 'Imagens/Cat-Breeds/Korat.jpg', @t),
    ('Maine Coon', 'Imagens/Cat-Breeds/Maine-Coon.jpg', @t),
    ('Manx', 'Imagens/Cat-Breeds/Manx.jpg', @t),
    ('Munchkin', 'Imagens/Cat-Breeds/Munchkin.jpg', @t),
    ('Nebelung', 'Imagens/Cat-Breeds/Nebelung.jpg', @t),
    ('Norwegian Forest Cat', 'Imagens/Cat-Breeds/Norwegian-Forest-Cat.jpg', @t),
    ('Ocicat', 'Imagens/Cat-Breeds/Ocicat.jpg', @t),
    ('Oriental Shorthair', 'Imagens/Cat-Breeds/Oriental-Shorthair.jpg', @t),
    ('Persian', 'Imagens/Cat-Breeds/Persian.jpg', @t),
    ('Ragdoll', 'Imagens/Cat-Breeds/Ragdoll.jpg', @t),
    ('Russian Blue', 'Imagens/Cat-Breeds/Russian-Blue.jpg', @t),
    ('Savannah', 'Imagens/Cat-Breeds/Savannah.jpg', @t),
    ('Scottish Fold', 'Imagens/Cat-Breeds/Scottish-Fold.jpg', @t),
    ('Selkirk Rex', 'Imagens/Cat-Breeds/Selkirk-Rex.jpg', @t),
    ('Siamese', 'Imagens/Cat-Breeds/Siamese.jpg', @t),
    ('Siberian', 'Imagens/Cat-Breeds/Siberian.jpg', @t),
    ('Somali', 'Imagens/Cat-Breeds/Somali.jpg', @t),
    ('Sphynx', 'Imagens/Cat-Breeds/Sphynx.jpg', @t),
    ('Tonkinese', 'Imagens/Cat-Breeds/Tonkinese.jpg', @t),
    ('Turkish Angora', 'Imagens/Cat-Breeds/Turkish-Angora.jpg', @t),
    ('Turkish Van', 'Imagens/Cat-Breeds/Turkish-Van.png', @t);
...
INSERT INTO competidor (nome, imagem, TemaId) VALUES
    ...
    ('Alaskan Malamute', 'Imagens/Dog-Breeds/Alaskan-Malamute.jpg', @t),
    ('Australian Cattle Dog', 'Imagens/Dog-Breeds/Australian-Cattle-Dog.jpg', @t),
    ('Australian Shepherd', 'Imagens/Dog-Breeds/Australian-Shepherd.jpg', @t),
    ('Basset Hound', 'Imagens/Dog-Breeds/Basset-Hound.jpg', @t),
    ('Beagle', 'Imagens/Dog-Breeds/Beagle.jpg', @t),
    ('Belgian Malinois', 'Imagens/Dog-Breeds/Belgian-Malinois.jpg', @t),
    ('Bernese Mountain Dog', 'Imagens/Dog-Breeds/Bernese-Mountain-Dog.jpg', @t),
    ('Bloodhound', 'Imagens/Dog-Breeds/Bloodhound.jpg', @t),
    ('Border Collie', 'Imagens/Dog-Breeds/Border-Collie.jpg', @t),
    ('Boston Terrier', 'Imagens/Dog-Breeds/Boston-Terrier.jpg', @t),
    ('Boxer', 'Imagens/Dog-Breeds/Boxer.jpg', @t),
    ('Bull Terrier', 'Imagens/Dog-Breeds/Bull-Terrier.jpg', @t),
    ('Bulldog', 'Imagens/Dog-Breeds/Bulldog.jpg', @t),
    ('Cane Corso', 'Imagens/Dog-Breeds/Cane-Corso.png', @t),
    ('Chihuahua', 'Imagens/Dog-Breeds/Chihuahua.jpg', @t),
    ('Chow Chow', 'Imagens/Dog-Breeds/Chow-Chow.jpg', @t),
    ('Cocker Spaniel', 'Imagens/Dog-Breeds/Cocker-Spaniel.jpg', @t),
    ('Corgi', 'Imagens/Dog-Breeds/Corgi.jpg', @t),
    ('Dachshund', 'Imagens/Dog-Breeds/Dachshund.jpg', @t),
    ...
    ('Greyhound', 'Imagens/Dog-Breeds/Greyhound.jpg', @t),
    ('Irish Setter', 'Imagens/Dog-Breeds/Irish-Setter.jpg', @t),
    ('Jack Russell Terrier', 'Imagens/Dog-Breeds/Jack-Russell-Terrier.jpg', @t),
    ('Labrador', 'Imagens/Dog-Breeds/Labrador.jpg', @t),
    ('Maltese', 'Imagens/Dog-Breeds/Maltese.jpg', @t),
    ('Newfoundland', 'Imagens/Dog-Breeds/Newfoundland.jpg', @t),
    ('Old English Sheepdog', 'Imagens/Dog-Breeds/Old-English-Sheepdog.jpg', @t),
    ('Pomeranian', 'Imagens/Dog-Breeds/Pomeranian.jpg', @t),
    ...
    ('Rhodesian Ridgeback', 'Imagens/Dog-Breeds/Rhodesian-Ridgeback.jpg', @t),
    ('Rottweiler', 'Imagens/Dog-Breeds/Rottweiler.jpg', @t),
    ('Saint Bernard', 'Imagens/Dog-Breeds/Saint-Bernard.jpg', @t),
    ('Samoyed', 'Imagens/Dog-Breeds/Samoyed.jpg', @t),
    ('Schnauzer', 'Imagens/Dog-Breeds/Schnauzer.jpg', @t),
    ('Shar Pei', 'Imagens/Dog-Breeds/Shar-Pei.jpg', @t),
    ('Shetland Sheepdog', 'Imagens/Dog-Breeds/Shetland-Sheepdog.jpg', @t),
    ...
    ('Staffordshire Bull Terrier', 'Imagens/Dog-Breeds/Staffordshire-Bull-Terrier.jpg', @t),
    ('Tibetan Mastiff', 'Imagens/Dog-Breeds/Tibetan-Mastiff.jpg', @t),
    ('Vizsla', 'Imagens/Dog-Breeds/Vizsla.jpg', @t),
    ('Weimaraner', 'Imagens/Dog-Breeds/Weimaraner.jpg', @t),
    ('West Highland White Terrier', 'Imagens/Dog-Breeds/West-Highland-White-Terrier.jpg', @t),
    ('Whippet', 'Imagens/Dog-Breeds/Whippet.jpg', @t),
...
-- ---------- Superheroes ----------
INSERT INTO tema (nome, utilizadorId, publico) VALUES ('Superheroes', @dono, 1)
    ON DUPLICATE KEY UPDATE publico = 1;
SET @t = (SELECT id FROM tema WHERE nome = 'Superheroes' AND utilizadorId = @dono);
DELETE FROM competidor WHERE TemaId = @t;
INSERT INTO competidor (nome, imagem, TemaId) VALUES
    ('Ant-Man', 'Imagens/Superheroes/Ant-Man.jpg', @t),
    ('Aquaman', 'Imagens/Superheroes/Aquaman.png', @t),
    ('Batgirl', 'Imagens/Superheroes/Batgirl.jpg', @t),
    ('Batman', 'Imagens/Superheroes/Batman.jpg', @t),
    ('Black Panther', 'Imagens/Superheroes/Black-Panther.png', @t),
    ('Black Widow', 'Imagens/Superheroes/Black-Widow.jpg', @t),
    ('Blade', 'Imagens/Superheroes/Blade.png', @t),
    ('Captain America', 'Imagens/Superheroes/Captain-America.jpg', @t),
    ('Captain Marvel', 'Imagens/Superheroes/Captain-Marvel.jpg', @t),
    ('Cyclops', 'Imagens/Superheroes/Cyclops.png', @t),
    ('Daredevil', 'Imagens/Superheroes/Daredevil.jpg', @t),
    ('Deadpool', 'Imagens/Superheroes/Deadpool.png', @t),
    ('Doctor Strange', 'Imagens/Superheroes/Doctor-Strange.jpg', @t),
    ('Ghost Rider', 'Imagens/Superheroes/Ghost-Rider.png', @t),
    ('Green Arrow', 'Imagens/Superheroes/Green-Arrow.png', @t),
    ('Green Lantern', 'Imagens/Superheroes/Green-Lantern.jpg', @t),
    ('Groot', 'Imagens/Superheroes/Groot.png', @t),
    ('Hawkeye', 'Imagens/Superheroes/Hawkeye.webp', @t),
    ('Hellboy', 'Imagens/Superheroes/Hellboy.jpg', @t),
    ('Hulk', 'Imagens/Superheroes/Hulk.png', @t),
    ('Invincible', 'Imagens/Superheroes/Invincible.jpg', @t),
    ('Iron Man', 'Imagens/Superheroes/Iron-Man.png', @t),
    ('Jean Grey', 'Imagens/Superheroes/Jean-Grey.webp', @t),
    ('Luke Cage', 'Imagens/Superheroes/Luke-Cage.png', @t),
    ('Magneto', 'Imagens/Superheroes/Magneto.jpg', @t),
    ('Martian Manhunter', 'Imagens/Superheroes/Martian-Manhunter.png', @t),
    ('Moon Knight', 'Imagens/Superheroes/Moon-Knight.png', @t),
    ('Nightwing', 'Imagens/Superheroes/Nightwing.jpg', @t),
    ('Professor X', 'Imagens/Superheroes/Professor-X.png', @t),
    ('Punisher', 'Imagens/Superheroes/Punisher.png', @t),
    ('Robin', 'Imagens/Superheroes/Robin.png', @t),
    ('Rocket Raccoon', 'Imagens/Superheroes/Rocket-Raccoon.png', @t),
    ('Scarlet Witch', 'Imagens/Superheroes/Scarlet-Witch.jpg', @t),
    ('Shazam', 'Imagens/Superheroes/Shazam.png', @t),
    ('She-Hulk', 'Imagens/Superheroes/She-Hulk.jpg', @t),
    ('Silver Surfer', 'Imagens/Superheroes/Silver-Surfer.png', @t),
    ('Spawn', 'Imagens/Superheroes/Spawn.jpg', @t),
    ('Spider-Man', 'Imagens/Superheroes/Spider-Man.png', @t),
    ('Star-Lord', 'Imagens/Superheroes/Star-Lord.png', @t),
    ('Storm', 'Imagens/Superheroes/Storm.png', @t),
    ('Supergirl', 'Imagens/Superheroes/Supergirl.png', @t),
    ('Superman', 'Imagens/Superheroes/Superman.png', @t),
    ('The Flash', 'Imagens/Superheroes/The-Flash.png', @t),
    ('Thor', 'Imagens/Superheroes/Thor.png', @t),
    ('Venom', 'Imagens/Superheroes/Venom.png', @t),
    ('Vision', 'Imagens/Superheroes/Vision.png', @t),
    ('Wolverine', 'Imagens/Superheroes/Wolverine.jpg', @t),
    ('Wonder Woman', 'Imagens/Superheroes/Wonder-Woman.jpg', @t);
